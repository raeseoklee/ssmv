...
- Clear the list with **File → Remove All from Sidebar…** or the sidebar context menu. Confirm **Remove All** to remove every entry; original files stay on disk.
