...
- 목록을 한 번에 비우려면 **File → Remove All from Sidebar…** 또는 사이드바 우클릭 메뉴를 선택합니다. 확인 창에서 **Remove All**을 눌러야 목록이 비워지며, 원본 파일은 그대로 남습니다.
