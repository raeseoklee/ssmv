...
final_app="$repository_root/dist/SSMV.app"
previous_build=0
...
staging_dir="$(mktemp -d "$repository_root/dist/.ssmv-build.XXXXXX")"
cleanup() {
...
cp "$repository_root/LICENSE" "$repository_root/THIRD_PARTY_NOTICES.md" "$app_path/Contents/Resources/"
